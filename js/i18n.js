...
const I18N = {
  ...
  zh: {
    ...
    nav_structure: "架构",
    struct_eyebrow: "集团架构",
    struct_title: "ODY 集团架构",
    struct_lead:
      "集团各实体之间清晰的架构，专为稳健的国际化扩张而设计。",
    struct_holding_tag: "控股母公司",
    struct_holding_name: "ODY International Holding",
    struct_holding_desc: "持有集团全部权益的顶层实体。",
    struct_fr_name: "ODY France",
    struct_fr_desc: "集团总部。",
    struct_country_label: "ODY",
    struct_country_desc: "在每个本地市场进行国际化部署。",
    struct_country_cycle: "中国,阿联酋,新加坡,美国,西班牙",
    struct_ventures_name: "其他相关项目",
    struct_ventures_desc: "",
    ...
    funds_2_title: "客户获取与营销",
    funds_2_d1: "面向餐厅与本地商户的 B2B 获客活动",
    funds_2_d2: "大规模内容与影响者策略",
    funds_2_d3: "大使计划",
    funds_2_d4: "创作者计划",
    funds_2_d5: "B2C 用户获取",
    funds_2_d6: "SEO 与合作伙伴",
    funds_2_d7: "品牌知名度",
